...
function TicketsTable({ type, collection, tickets, searchKey, updateSearchKey, selectProject, selectedProject }) {
  ...
  return (
      <Paper className={classes.wrapper}>
        <Typography className={classes.sectionTitle} variant="h4">Project Tickets</Typography>
        <Divider/>
        <br/>
        {/* <Divider/> */}
        <TableContainer >
              ...
              {(rowsPerPage > 0
                ...
                <StyledTableRow key={row.title}>
                  <StyledTableCell component="th" scope="row">
                    {truncateString(row.title, 50)}
                  </StyledTableCell>
                  <StyledTableCell align="left">{truncateString(row.body, 50)}</StyledTableCell>
